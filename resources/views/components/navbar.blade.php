<nav class="bg-gray-800" x-data="{ mobileMenuOpen: true }">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="/kategori" :active="request()->is('kategori')">List Kategori</x-nav-link>
                        <x-nav-link href="/buku" :active="request()->is('buku')">List Buku</x-nav-link>
                        <x-nav-link href="/peminjaman" :active="request()->is('peminjaman')">List Peminjaman</x-nav-link>
                        <x-nav-link href="/daftar" :active="request()->is('daftar')">Daftar Member</x-nav-link>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
    ...
    <div class="-mr-2 flex md:hidden">
        ...
        <button @click="mobileMenuOpen = !mobileMenuOpen" type="button"
            ...
            <svg x-show="!mobileMenuOpen" x-transition:enter="transition ease-in duration-75"
                ...
                x-transition:leave-end="opacity-0 scale-75" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-100 transform"
        ...
        x-transition:leave-end="opacity-0 scale-95" class="block md:hidden">
        ...
        <div class="border-t border-white/10 pt-4 pb-3">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Dafaafandi</div>
                    <div class="text-sm font-medium text-gray-400">dafaafandi@example.com</div>
                </div>
            </div>
            <div class="mt-3 space-y-1 px-2">
                ...
                <a href="/logout" class="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5">Sign out</a>
            </div>
        </div>
    </div>
</nav>
